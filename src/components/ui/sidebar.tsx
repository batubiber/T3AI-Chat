...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Spacer - pushes content, animates width only */}
      <div
        className={cn(
          "relative h-svh shrink-0 bg-transparent transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
          state === "expanded" ? "w-[252px]" : "w-[76px]",
          "group-data-[collapsible=offcanvas]:w-0",
          "group-data-[side=right]:rotate-180",
        )}
      />
      {/* Fixed sidebar panel - animates width with same timing */}
      <div
        data-sidebar="sidebar"
        className={cn(
          "fixed z-10 hidden md:flex flex-col",
          "left-3 top-3 bottom-3",
          "bg-card rounded-[20px] shadow-[0_0_20px_5px_rgba(0,0,0,0.05)] dark:shadow-none",
          "transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
          "overflow-hidden",
          state === "expanded" ? "w-[240px]" : "w-[64px]",
